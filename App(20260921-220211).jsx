...
const GlobalStyle = () => (
  <style>{`
    ...
    .nrr-root { font-family: 'Inter', sans-serif; color: var(--ink); background: var(--snow); font-size: 16px; }
    @media (min-width: 1024px) {
      .nrr-root { font-size: 17px; }
      .nrr-root .text-sm { font-size: 0.95rem; }
      .nrr-root .text-xs { font-size: 0.82rem; }
    }
            ...
            <div className="relative z-10 p-5 sm:p-6 flex flex-wrap items-end justify-between gap-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-3 bg-white/80 rounded-xl px-3 py-2 border nrr-focus"
                ...
                {profileOpen && (
                  <div className="absolute right-0 top-full mt-2 z-50 w-[22rem] max-w-[calc(100vw-2rem)] bg-white rounded-xl border shadow-2xl p-5" style={{ borderColor: "var(--ice-line)" }}>

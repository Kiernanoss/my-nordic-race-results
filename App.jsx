  ...
  return (
    <div className="flex flex-col gap-6 max-w-xl">
      ...
      <Card className="p-6">
        ...
        <form onSubmit={(e) => { e.preventDefault(); setAppState((s) => ({ ...s, profile: { ...form, aliases: Array.isArray(form.aliases) ? form.aliases : String(form.aliases || "").split(",").map((a) => a.trim()).filter(Boolean) } })); }} className="grid grid-cols-2 gap-4">
      ...
      <Card className="p-6">
        ...
        <p className="text-sm mb-4" style={{ color: "var(--slate)" }}>
          Upload or paste the <code className="nrr-num">results.json</code> produced by the scraper. Imported races are merged in alongside — not instead of — the sample dataset, matched to teammates and your profile the same way as everything else.
        </p>

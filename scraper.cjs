...
const DEFAULTS = {
  ...
  // IMPORTANT:
  // Start at RaceKey 1566 so the earlier season races are included.
  startId: 1566,
...
async function main() {
   ...
   *
   * The scraper now starts at RaceKey 1566, but we also keep every
   ...
   * STEP 1
   *
   * Discover RaceKeys beginning at 1566.
   */
  const races =
